...
class Evaluator:
    ...
    def _evaluate_with_tables(
        ...
        *,
        ...
        # No `plan=`: the accumulator carries the plan its grid's kernel
        # requires (ADR-0062), so naming it here would be a second
        # source of truth for a fact the handle already holds.
