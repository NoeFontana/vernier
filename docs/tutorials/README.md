...
- [Your first evaluation](first-evaluation.md) — run vernier end-to-end
  on COCO val2017 and read the 12-line summary.
- [Logging AP during training](training-loop.md) — wire
  `BackgroundEvaluator` into a training loop without stalling on the
  matching kernel.
