...
| [0019](0019-result-tables.md) | Result tables — opt-in, Arrow-backed, zero-overhead by default | accepted (stub-gen claim is errata — see `docs/engineering/python-type-stubs.md`) |
...
| [0055](0055-drop-in-params-surface-and-coco-json-adapters.md) | Finish the `COCOeval` drop-in's mutable surface (`ious`, `catIds`); publish the COCO-JSON normalizers | accepted |
