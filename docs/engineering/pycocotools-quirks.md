...
| J4 | DT `iscrowd = 0` always. Per E2. | co:344, co:353 | **strict**. | `dataset.rs:469-484`; test `loads_detections_from_json_array:917`; ADR-0056 routes covered by `tests/python/test_ingest_route_equivalence.py::test_area_and_iscrowd_fields_are_ignored`. ✓ |
