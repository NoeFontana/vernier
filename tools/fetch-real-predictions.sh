...
# (panoptic + ADE-semantic), and ViTPose predictions are inferred
# locally via the `real-models` extra (TIDE and SOTA harnesses) —
# see the package README. Available flags:
