...
fn slices_instance_ap_schema() -> Schema {
    Schema::new(vec![
        ...
        Field::new("ap_small", DataType::Float64, false),
        Field::new("ap_medium", DataType::Float64, false),
        Field::new("ap_large", DataType::Float64, false),
        Field::new("ar_1", DataType::Float64, false),
        Field::new("ar_10", DataType::Float64, false),
        Field::new("ar_100", DataType::Float64, false),
        Field::new("ar_small", DataType::Float64, false),
        Field::new("ar_medium", DataType::Float64, false),
        Field::new("ar_large", DataType::Float64, false),
    ])
